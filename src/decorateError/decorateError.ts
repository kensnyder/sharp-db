import type { SharpDbError, SqlOptionsInterface } from '../types';

/**
 * Give MySQL error a more verbose `stack` and `message`
 * @param error  Error object thrown by msql2 library
 * @param options  Options generated by various Db functions
 * @property options.sql  The final SQL string that was executed
 * @property options.bound  Key-value pairs of bound values
 */
export default function decorateError(
	error: SharpDbError,
	options: SqlOptionsInterface = {}
) {
